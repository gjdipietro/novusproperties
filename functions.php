...
function html5blank_nav()
{
	...
	array(
		...
		'link_before'     => '',
		'link_after'      => '',
		'items_wrap'      => '<ul class="c-masthead__nav__menu js-menu">%3$s</ul>',
		'depth'           => 0,
		'walker'          => ''
		)
	);
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        wp_register_script('html5blankscripts', get_template_directory_uri() . '/dist/js/app.js', '1.0.0'); // Custom scripts
...
{
    wp_register_style('html5blank', get_template_directory_uri() . '/css/styles.css', array(), '1.1', 'all');
